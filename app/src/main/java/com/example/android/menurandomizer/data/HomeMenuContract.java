...
public class HomeMenuContract {
    ...
    public static final String AUTHORITY = "com.example.android.menurandomizer";

    // The base content URI = "content://" + <authority>
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + AUTHORITY);

    // This is the path for the "dishes" directory
    public static final String PATH_DISHES = "dishes";

    // DishEntry is an inner class that defines the contents of the task table
    public static final class DishEntry implements BaseColumns {

        // DishEntry content URI = base content URI + path
        ...
        // Since DishEntry implements the interface "BaseColumns", it has an automatically produced
