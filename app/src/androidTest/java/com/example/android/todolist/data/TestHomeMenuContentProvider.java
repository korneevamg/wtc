...
public class TestHomeMenuContentProvider {
    ...
    @Before
    public void setUp() {
        /* Use HomeMenuDbHelper to get access to a writable database */
        HomeMenuDbHelper dbHelper = new HomeMenuDbHelper(mContext);
        SQLiteDatabase database = dbHelper.getWritableDatabase();
        database.delete(HomeMenuContract.DishEntry.TABLE_NAME, null, null);
    }
    ...
    public void testProviderRegistry() {
        ...
        String taskProviderClassName = HomeMenuContentProvider.class.getName();
        ...
        try {
            ...
            String incorrectAuthority =
                    "Error: HomeMenuContentProvider registered with authority: " + actualAuthority +
            ...
            String providerNotRegisteredAtAll =
                    "Error: HomeMenuContentProvider not registered at " + mContext.getPackageName();
            /*
    ...
    private static final Uri TEST_TASKS = HomeMenuContract.DishEntry.CONTENT_URI;
    ...
    public void testUriMatcher() {
        ...
        /* Create a URI matcher that the HomeMenuContentProvider uses */
        UriMatcher testMatcher = HomeMenuContentProvider.buildUriMatcher();
        ...
        int expectedTasksMatchCode = HomeMenuContentProvider.ALLDISHES;
        ...
        int expectedTaskWithIdCode = HomeMenuContentProvider.SINGLEDISH;
    ...
    public void testInsert() {
        ...
        testTaskValues.put(HomeMenuContract.DishEntry.COLUMN_DESCRIPTION, "Test description");
        testTaskValues.put(HomeMenuContract.DishEntry.COLUMN_DISHTYPE, 1);
        ...
        contentResolver.registerContentObserver(
                ...
                HomeMenuContract.DishEntry.CONTENT_URI,
        ...
        Uri uri = contentResolver.insert(HomeMenuContract.DishEntry.CONTENT_URI, testTaskValues);


        Uri expectedUri = ContentUris.withAppendedId(HomeMenuContract.DishEntry.CONTENT_URI, 1);
    ...
    public void testQuery() {
        ...
        long taskRowId = database.insert(
                ...
                HomeMenuContract.DishEntry.TABLE_NAME,
                null,
    ...
    public void testDelete() {
        ...
        HomeMenuDbHelper helper = new HomeMenuDbHelper(InstrumentationRegistry.getTargetContext());
        ...
        Uri uriToDelete = HomeMenuContract.DishEntry.CONTENT_URI.buildUpon().appendPath("1").build();
